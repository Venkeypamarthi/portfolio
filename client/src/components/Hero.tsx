  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-40 right-20 w-96 h-96 bg-teal-accent/20 rounded-full blur-3xl animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-20 left-1/2 w-80 h-80 bg-green-accent/20 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-slide-up">
            ...
            <p className="text-xl text-text-muted max-w-lg">
              Passionate AI & Data Science student specializing in Full Stack Development, Machine Learning, and Cloud Computing solutions.
            </p>
