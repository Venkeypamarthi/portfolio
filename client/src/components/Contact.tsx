    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex items-center justify-center gap-3 mb-12">
          ...
          <Send
            className="text-teal-accent animate-pulse"
            size={28}
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="group flex items-center space-x-4 p-4 rounded-xl bg-dark-card/50 hover:bg-dark-card transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-blue-accent/10 animate-slide-up cursor-pointer hover-glow">
                  <div className="w-12 h-12 bg-blue-accent/20 rounded-lg flex items-center justify-center group-hover:bg-blue-accent/30 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                    <Mail
                      className="text-blue-accent group-hover:animate-pulse"
                      size={20}
                    />
                  </div>
                  <div className="flex-1">
                    <p className="text-text-muted text-sm group-hover:text-blue-accent transition-colors duration-300">Email</p>
                    <p className="font-semibold group-hover:text-blue-accent transition-colors duration-300 text-hover-glow">
                      1918171venkannababu@gmail.com
                    </p>
                  </div>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <MessageCircle className="text-blue-accent animate-pulse" size={16} />
                  </div>
                </div>

                <div
                  className="group flex items-center space-x-4 p-4 rounded-xl bg-dark-card/50 hover:bg-dark-card transition-all duration-300 hover:scale-105 animate-slide-up"
                ...
                >
                  <div className="w-12 h-12 bg-teal-accent/20 rounded-lg flex items-center justify-center group-hover:bg-teal-accent/30 group-hover:scale-110 transition-all duration-300">
                    <Phone
                      className="text-teal-accent group-hover:animate-pulse"
                      size={20}
                    />
                  </div>
                  <div>
                    <p className="text-text-muted text-sm">Phone</p>
                    <p className="font-semibold group-hover:text-teal-accent transition-colors duration-300">
                      +91 6304319191
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="w-12 h-12 bg-green-accent/20 rounded-lg flex items-center justify-center group-hover:bg-green-accent/30 group-hover:scale-110 transition-all duration-300">
                    <MapPin
                      className="text-green-accent group-hover:animate-pulse"
                      size={20}
                    />
                  </div>
                  <div>
                    <p className="text-text-muted text-sm">Location</p>
                    <p className="font-semibold group-hover:text-green-accent transition-colors duration-300">
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <div
                    className="group w-12 h-12 bg-dark-card rounded-lg flex items-center justify-center hover:bg-dark-border transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer animate-fade-in"
                    style={{ animationDelay: "0.2s" }}
                  >
                    <Github
                      className="text-text-primary group-hover:animate-pulse"
                      size={20}
                    />
                  </div>
                  <div
                    className="group w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center hover:from-purple-600 hover:to-pink-600 transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer animate-fade-in"
                    style={{ animationDelay: "0.4s" }}
                  >
                    <Instagram
                ...
                <div className="mt-4 space-y-2 text-sm text-text-muted"></div>
              </div>
            </div>

            <div
              className="bg-dark-card p-8 rounded-xl hover:bg-dark-card/80 transition-all duration-300 animate-slide-up"
